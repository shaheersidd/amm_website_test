  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <div className="w-6 h-6 rounded bg-gradient-to-tr from-[#3B82F6] to-[#00D6FF] flex items-center justify-center opacity-90">
          <div className="w-2.5 h-2.5 bg-[#050505] rounded-sm" />
        </div>
        <span className="font-semibold text-lg tracking-tight text-white/90">
          AMM <span className="text-white/50 font-normal">Lab</span>
        </span>
      </div>
